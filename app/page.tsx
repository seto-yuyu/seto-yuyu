...
export default function Home() {
  return (
    <>
      {/* ========== Header ========== */}
      <header className="fixed top-0 left-0 right-0 z-40 backdrop-blur-sm bg-cream/95 border-b border-gold/25">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a
              href={LINE_URL}
              className="flex items-center gap-2 text-white font-bold px-5 py-2 text-sm hover:opacity-90 transition-opacity"
